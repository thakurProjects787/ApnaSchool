...
public class ShowStatesSchools extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_states_schools);

        Toolbar toolbar = (Toolbar) findViewById(R.id.show_all_state_schools_details_toolbar);
        ...
        allDetails=(ListView)findViewById(R.id.show_all_state_schools_details_lv);

        adapter=new ShowSchoolAdapter(ShowStatesSchools.this,allEachSchoolsDetails);
        ...
        if(schoolIntentStatus.equals("OWNER")){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.show_all_schools_on_map) {
            ...
            Intent intent = new Intent(ShowStatesSchools.this, DisplaySchoolsOnMaps.class);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
                    ...
                    for(DataSnapshot postSnapShot:dataSnapshot.getChildren())
                    {
                        ...
                        // Read school details
                        getDisttLevelData(allSchools.getNewuserID());
    ...
    // Read DIstrict level data
    public void getDisttLevelData(String schoolDataID) {

        showProgressDialog();
        mDatabase.child("UserNode").child(schoolDataID).child("Sub_User").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
    ...
    private void showProgressDialog() {
        if (mProgressDialog == null) {
            mProgressDialog = new ProgressDialog(ShowStatesSchools.this);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ShowStatesSchools.this, ShowEachSchoolDetails.class);
