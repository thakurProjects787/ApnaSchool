...
public class ShowOpenPointsActivity extends AppCompatActivity {
    ...
    //Inner class object
    ShowOpenPointsActivity.ShowOpenPointsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_open_points);

        Toolbar toolbar = (Toolbar) findViewById(R.id.show_open_points_toolbar);
        ...
        allDetails=(ListView)findViewById(R.id.show_open_points_lv);

        adapter=new ShowOpenPointsActivity.ShowOpenPointsAdapter(ShowOpenPointsActivity.this,achivDetails);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_new_details) {
            ...
            if(parentAtivityMsg.equals("OWNER")) {
                Intent intent = new Intent(ShowOpenPointsActivity.this, AddNewOpenPointsActivity.class);
                intent.putExtra("EXTRA_OPENPOINTS_INFO_SESSION_ID", "ADD_NEW");
    ...
    public void getDataFromServer() {
        ...
        showProgressDialog();
        mDatabase.child("UserNode").child(school_firbasedataID).child("Open_Points").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void showProgressDialog() {
        if (mProgressDialog == null) {
            mProgressDialog = new ProgressDialog(ShowOpenPointsActivity.this);
    ...
    private class ShowOpenPointsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ShowOpenPointsActivity.ShowOpenPointsAdapter.ViewHolder holder;

            if (convertView == null) {
                convertView = layoutInflater.inflate(R.layout.model_show_all_achivments, null, false);
                holder = new ShowOpenPointsActivity.ShowOpenPointsAdapter.ViewHolder();
                ...
                holder = (ShowOpenPointsActivity.ShowOpenPointsAdapter.ViewHolder) convertView.getTag();
            }

            AchivmentsDetails acDetails=achivDetails.get(position);

            // Find Tags
            String tags = acDetails.getAchv_date().split("##")[0];
